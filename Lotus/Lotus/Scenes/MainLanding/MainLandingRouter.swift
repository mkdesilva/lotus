...
protocol MainLandingRouterInterface {
  func navigateToSomewhere()
}

class MainLandingRouter: MainLandingRouterInterface {
  weak var viewController: MainLandingViewController!
